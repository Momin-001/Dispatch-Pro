...
export default function DispatcherVerificationPage() {
  ...
  return (
    <div className="w-full space-y-6">
      <div>
        <h1 className="2xl:text-3xl text-2xl font-semibold text-foreground">Dispatcher Verification</h1>
        <p className="mt-1 lg:text-base 2xl:text-lg text-muted-foreground">
      ...
      <SectionCard title="Personal Information">
        <form onSubmit={handleSubmit(onSaveProfile)} className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <EditableFieldLabel label="Experience (years)" />
              <Input placeholder="e.g. 5" {...register("yearsExperience")} />
            </div>
            <div>
              <EditableFieldLabel label="Region" />
              <Input placeholder="e.g. Midwest, Southeast" {...register("region")} />
            </div>
          </div>
